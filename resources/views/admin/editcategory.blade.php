                        ...
                        <div class="col-xl">
                            <div class="card mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h5 class="mb-6 pt-6 pb-6">Edit Category</h5>
    ...
    margin: 10px 0px 10px 0px;">
                                        ...
                                        <div class="mb-3 mt-0">
                                            ...
                                            <input type="text"
                                                ...
                                                is-invalid
                                            @enderror"
                                                id="basic-default-fullname" name="name" value="{{ $category->name }}" />
                                        </div>
                                        <div class="mb-3">
                                            @error('Status')
                                                <div
    ...
    margin: 10px 0px 10px 0px;">
                                            ...
                                            @enderror"
                                                ...
                                                <option value="deactive"
                                                    {{ $category->status == 'deactive' ? 'selected' : '' }}>
                                                    Deactive</option>
                                            </select>
                                        </div>
                                        <button type="submit" class="btn btn-primary mb-2 mt-3">Update Category</button>
                                    </form>
                                </div>
                            </div>
                        </div>
