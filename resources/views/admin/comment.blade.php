        ...
        <div id="layoutSidenav_content">
            <div class="container-lg">
                <div class="header_part">
                    <h5><a href="{{ route('commnet_show') }}">Comments Manage</a>
                    </h5>
                    <div class="right_content">
                        <form action="{{ route('commnet_filter') }}" method="POST"
                            ...
                            @if ($posts->isNotEmpty())
                                @foreach ($posts as $post)
                                    <tr>
                                        ...
                                        <td>
                                            <p class="fw-normal mb-1 ellipsis">{{ $post->comment }}
                                            </p>
                                        </td>
                                        <td>
                                        ...
                                        <td class="edit_delete">
                                            <button type="button" class="btn btn-link p-0 text-danger btn-delete"
                                                data-url="{{ route('comment_delete', $post->id) }}"
                                                data-name="{{ Str::limit($post->comment, 30) }}" data-bs-toggle="modal"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p id="deleteMessage">Are you sure you want to delete this comment?</p>
            </div>
