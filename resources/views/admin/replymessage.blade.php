            ...
            <div class="container-lg">
                <div class="header_part">
                    ...
                    <div class="right_content">
                        <a href="{{ route('contect_show') }}">Back</a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-xl">
                            <div class="card mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h5 class="mb-6 pt-6 pb-6">Reply Contact</h5>
                                ...
                                @endif
                                <div class="card-body">
                                    <form action="{{ route('contect_sents', ['id' => $post->id]) }}" method="POST">
                                        @csrf
                                        <div class="mb-3 mt-0">
                                            <label class="form-label" for="basic-default-fullname">Contact
                                                email</label>
                                            <input type="text" class="form-control" id="basic-default-fullname"
                                                name="email" value="{{ $post->email }}" readonly />
                                        </div>
                                        ...
                                        <div class="mb-3 mt-0">
                                            ...
                                            <textarea class="form-control @error('message') is-invalid @enderror" id="description" name="message" rows="5"
                                                placeholder="Enter post description"></textarea>
                                        </div>
                                        <button type="submit" class="btn btn-primary mb-2 mt-3">Sent Message</button>
                                    </form>
                                </div>
                            </div>
                        </div>
