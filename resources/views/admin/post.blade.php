        ...
        <div id="layoutSidenav_content">
            <div class="container-lg">
                <div class="header_part">
                    <h5><a href="{{ route('all_category') }}">Post Manage</a>
                    </h5>
                    <div class="right_content">
                        <a href="{{ route('Show_post') }}"><i class="fa-solid fa-plus"></i>Create Post</a>
                        <form action="{{ route('filter_post') }}" method="POST"
                                ...
                                @foreach ($posts as $post)
                                    <tr>
                                        ...
                                        <td class="edit_delete">
                                            <a href="{{ route('edit_post', $post->id) }}"><i class="fas fa-edit"></i></a>

                                            @if (Auth::user()->hasRole('admin'))
                                                <button type="button" class="btn btn-link p-0 text-danger btn-delete"
                                                    data-url="{{ route('delete_post', $post->id) }}"
                                                    data-name="{{ $post->title }}" data-bs-toggle="modal"
