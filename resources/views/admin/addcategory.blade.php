...
@section('content')
        ...
        <div id="layoutSidenav_content">
            <div class="container-lg">
                <div class="header_part">
                    <h5>Creat New Category</h5>
                    <div class="right_content">
                        <a href="{{ route('all_category') }}">Back</a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-xl">
                            <div class="card mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h5 class="mb-6 pt-6 pb-6">Create New Category</h5>
                                ...
                                @endif
                                <div class="card-body">
                                    <form action="{{ route('Create_Categore') }}" method="post">
                                        @csrf
                                        @error('name')
                                            <div
    ...
    margin: 10px 0px 10px 0px;">
                                        ...
                                        @enderror
                                        <div class="mb-3 mt-0">
                                            <label class="form-label" for="basic-default-fullname">Enter Category
                                                Name</label>
                                            <input type="text"
    ...
    margin: 10px 0px 10px 0px;">
                                            ...
                                            <label for="exampleFormControlSelect1" class="form-label">Category Status
                                            </label>
                                            <select
                                            ...
                                            @enderror"
                                                ...
                                                <option value="deactive"
                                                    {{ old('Status') == 'deactive' ? 'selected' : '' }}>
                                                    Deactive</option>
                                            </select>
                                        </div>
                                        <button type="submit" class="btn btn-primary mb-2 mt-3">Create Category</button>
                                    </form>
                                </div>
                            </div>
                        </div>
