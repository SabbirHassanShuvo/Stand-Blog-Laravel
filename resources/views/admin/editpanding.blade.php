...
@section('content')
                        ...
                        <div class="col-xl">
                            <div class="card mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h5 class="mb-6 pt-6 pb-6">Edit Pandding Post</h5>
                                ...
                                @endif
                                <div class="card-body">
                                    <form action="{{ route('update_panding', ['id' => $post->id]) }}" method="POST">
                                        @csrf
                                        <div class="mb-3">
                                            @error('publish')
                                                <div
    ...
    margin: 10px 0px 10px 0px;">
                                        ...
                                        <button type="submit" class="btn btn-primary mb-2 mt-3">Published</button>
                                    </form>
                                </div>
                            </div>
                        </div>
