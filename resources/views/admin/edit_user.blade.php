                                    ...
                                    <form action="{{ route('update_user', ['id' => $user->id]) }}" method="POST">
                                        ...
                                        <div class="mb-3 mt-0">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                                id="basic-default-fullname" name="name" value="{{ $user->name }}" />
                                        </div>
                                        <div class="mb-3">
                                            @error('email')
                                                <div
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('user_role') is-invalid @enderror"
                                                ...
                                                <option value="moderator"
                                                    {{ $user->user_role === 'moderator' ? 'selected' : '' }}>
                                                    Moderator</option>
                                                <option value="user" {{ $user->user_role === 'user' ? 'selected' : '' }}>
                                                    User</option>
                                            </select>
                                        </div>
                                        <button type="submit" class="btn btn-primary mb-2 mt-3">Update User</button>
                                    </form>
                                </div>
                            </div>
                        </div>
